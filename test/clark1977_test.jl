...
@testitem "IsentropicBaseState Structure" setup = [Clark1977Setup] tags = [:clark1977] begin
...
@testitem "IsentropicBaseState Surface Values" setup = [Clark1977Setup] tags = [:clark1977] begin
    @named bs = IsentropicBaseState()
    sys = mtkcompile(bs)
...
@testitem "IsentropicBaseState Profile" setup = [Clark1977Setup] tags = [:clark1977] begin
    @named bs = IsentropicBaseState()
    sys = mtkcompile(bs)
...
@testitem "IsentropicBaseState Hydrostatic Balance" setup = [Clark1977Setup] tags = [:clark1977] begin
    @named bs = IsentropicBaseState()
    sys = mtkcompile(bs)
...
@testitem "WitchOfAgnesi Structure" setup = [Clark1977Setup] tags = [:clark1977] begin
...
@testitem "WitchOfAgnesi Peak and Symmetry" setup = [Clark1977Setup] tags = [:clark1977] begin
    @named topo = WitchOfAgnesi()
    sys = mtkcompile(topo)
...
@testitem "WitchOfAgnesi Limiting Behavior" setup = [Clark1977Setup] tags = [:clark1977] begin
    @named topo = WitchOfAgnesi()
    sys = mtkcompile(topo)
...
@testitem "WitchOfAgnesi 1km Mountain" setup = [Clark1977Setup] tags = [:clark1977] begin
    @named topo = WitchOfAgnesi()
    sys = mtkcompile(topo)
...
@testitem "TerrainFollowingTransform Structure" setup = [Clark1977Setup] tags = [:clark1977] begin
...
@testitem "TerrainFollowingTransform Flat Terrain" setup = [Clark1977Setup] tags = [:clark1977] begin
    @named tft = TerrainFollowingTransform()
    sys = mtkcompile(tft)
...
@testitem "TerrainFollowingTransform Boundary Mapping" setup = [Clark1977Setup] tags = [:clark1977] begin
    @named tft = TerrainFollowingTransform()
    sys = mtkcompile(tft)
...
@testitem "TerrainFollowingTransform Jacobian" setup = [Clark1977Setup] tags = [:clark1977] begin
    @named tft = TerrainFollowingTransform()
    sys = mtkcompile(tft)
...
@testitem "TerrainFollowingTransform Metric Coefficients" setup = [Clark1977Setup] tags = [:clark1977] begin
    @named tft = TerrainFollowingTransform()
    sys = mtkcompile(tft)
...
@testitem "SmagorinskyTurbulence Structure" setup = [Clark1977Setup] tags = [:clark1977] begin
...
@testitem "SmagorinskyTurbulence Zero Deformation" setup = [Clark1977Setup] tags = [:clark1977] begin
    @named smag = SmagorinskyTurbulence()
    sys = mtkcompile(smag)
...
@testitem "SmagorinskyTurbulence Known Values" setup = [Clark1977Setup] tags = [:clark1977] begin
    @named smag = SmagorinskyTurbulence()
    sys = mtkcompile(smag)
...
@testitem "SmagorinskyTurbulence Full Deformation" setup = [Clark1977Setup] tags = [:clark1977] begin
    @named smag = SmagorinskyTurbulence()
    sys = mtkcompile(smag)
...
@testitem "MountainWave2D Construction" setup = [Clark1977Setup] tags = [:clark1977] begin
    sys = MountainWave2D()
...
@testitem "MountainWave2D Froude Number" setup = [Clark1977Setup] tags = [:clark1977] begin
    # Inverse Froude number F = a*N/(2π*U) (Eq. 7.5)
    F = 3000.0 * 0.01 / (2π * 4.0)
    @test F ≈ 1.18 rtol = 0.02
end

@testitem "MountainWave2D Solve" setup = [Clark1977Setup] tags = [:clark1977] begin
    using MethodOfLines
